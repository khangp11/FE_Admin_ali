...
export const ProductItem: React.FC<PropductItem> = ({
    ...
    const { id, food_name, description, image, price } = product;
        ...
        >
            ...
            >
                <CardMedia
                    ...
                    alt={food_name}
                    src={`http://res.cloudinary.com/dlxwm5pax/image/upload/v1700937458/${image}.jpg`}
                />
            </Box>
            <CardContent
                sx={{
            ...
            >
                ...
                >{`#10000${id}`}</Typography>
                <Tooltip title={`${price.toLocaleString()} VND`} placement="top">
                    <Typography
                        sx={{
                            fontWeight: 500,
                            fontSize: "24px",
